...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Bulan Mei 2022 pada 05.49
...
ALTER TABLE `tbl_murid`
  ...
  ADD CONSTRAINT `tbl_murid_ibfk_2` FOREIGN KEY (`kd_jur`) REFERENCES `tbl_jurusan` (`kd_jur`) ON DELETE CASCADE ON UPDATE CASCADE,
